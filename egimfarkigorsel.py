...
gelenaci = st.slider("Torç Açısı (Derece)", min_value=0, max_value=90, value=45)
...
def update_plot(aci):
        ...
        n = donme_noktasi_y + isin_uzunluk  # Y-eksenini kestiği nokta
...
# İlk çizim
update_plot(gelenaci)  # Başlangıçta progress bar değerini kullan
